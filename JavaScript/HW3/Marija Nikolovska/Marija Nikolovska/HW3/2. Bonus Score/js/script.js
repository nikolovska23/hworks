...
function validUserInput() {
    ...
    // Primer kako bi bilo so Do while
    // let input
    // do {
    //     input = prompt("Enter a score between 1-9");
...
/*
Odlicno reseno, mnogu mi se dopaga validacijata i povikuvanjeto funkcija vo funkcija bravos!!
*/
